// ============================================================
// Sonnendach.ch – API Wrapper Engine
// Queries Swiss roof solar potential via GeoAdmin REST API.
// No API key required. Swiss coverage only.
// ============================================================

window.Sonnendach = (function () {
  ...
  async function calculate(input) {
    ...
    if (!json.results || !json.results.length)
      return { error: 'No roof data found at this location.' };

    const a = json.results[0].attributes;
    return {
      roof_area_m2: a.flaeche || a.area || null,
      ...
      roof_pitch_deg: a.neigung || a.tilt || null,
      roof_orientation: a.ausrichtung || a.orientation || null,
